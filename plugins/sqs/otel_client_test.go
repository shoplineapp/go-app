...
<ReceiveMessageResponse xmlns="http://queue.amazonaws.com/doc/2012-11-05/">
  <ReceiveMessageResult>
    <Message>
      <MessageId>recv-msg-id</MessageId>
      <ReceiptHandle>recv-handle</ReceiptHandle>
      <MD5OfBody>` + md5Of("test body") + `</MD5OfBody>
      <Body>test body</Body>
      <MessageAttribute>
        <Name>traceparent</Name>
        <Value>
          <StringValue>00-4bf92f3577b34da6a3ce929d0e0e4736-00f067aa0ba902b7-01</StringValue>
...
func TestInstrument_ReceiveMessage_LinksToCreationContext(t *testing.T) {
	exporter := setupTestTracer(t)
	fake := newFakeSQSServer(t)
	client := newTestSQSClient(t, fake.URL)
	...
	linkedSC := s.Links[0].SpanContext
	assert.True(t, linkedSC.IsValid())
	assert.Equal(t, "4bf92f3577b34da6a3ce929d0e0e4736", linkedSC.TraceID().String())
}
