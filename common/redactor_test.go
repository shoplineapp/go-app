...
func TestFilterField(t *testing.T) {
	...
	tests := []test{
		...
		{NewFilter(nil, "A", PartialRedact), map[string]string{}, "A", true},
		{NewFilter(nil, "AccessToken", PartialRedact), map[string]string{}, "access_token", true},
		{NewFilter(nil, "AccessToken", PartialRedact), map[string]string{}, "AccessToken", true},
		{NewFilter(nil, "AccessToken", PartialRedact), map[string]string{}, "accessToken", true},
		{NewFilter(nil, "access_token", PartialRedact), map[string]string{}, "access_token", true},
		{NewFilter(nil, "access_token", PartialRedact), map[string]string{}, "AccessToken", true},
		{NewFilter(nil, "access_token", PartialRedact), map[string]string{}, "accessToken", true},
